...
| Accessing PACE data via earthaccess | [{{ l1 }}][ed-l] | [{{ l1 }}][ed-n] | [⬇️](nb:pace_earthdata_access.ipynb) <a href="../../_sources/presentations/notebooks/pace_earthdata_access.ipynb" download>{{ d1 }}</a> | [{{ v1 }}][ed-v] |  [{{ c1 }}][ed-c] |
